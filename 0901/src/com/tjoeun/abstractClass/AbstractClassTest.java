...
//  추상 클래스의 모든 추상 메소드를 만드시 override 시켜서 사용해야 한다. => 다형성 구현에 사용한다.
...
//	추상 메소드가 포함된 클래스를 상속받는 자식 클래스에서 반드시 override 시켜서 사용해야 하는 메소드이다
//	=> 프로그래머에게 반드시 override를 해서 사용하게끔 강제한다.
//	자식 클래스에서 반드시 override 시켜서 사용해야한다는 강제성을 프로그래서에게 부여하고
//	추상 메소드의 {}블록에 코딩해봐야 자식 클래스에서 무조건 override를 하게되면 부모 클래스에서
//	정의한 메소드 내용은 무시되므로 팔아프게 {}블록에 내용을 코딩해봐야 어짜피 무시될거 {} 블록을
//	아예 코딩하지 않는다.
