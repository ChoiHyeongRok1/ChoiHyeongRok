	...
	<form class="m-3" action="insertOK.jsp" method="post">
		<table class="table" style="width: 700px; margin-left: auto; margin-right: auto;">
			<tr class="table-success">
				<th colspan="3" style="font-size: 30px; text-align: center;">자유게시판 글쓰기</th>
			</tr>
			<tr>
				<th class="align-middle table-secondary" width="100">
			...
			<tr>
				...
				<td width="500" colspan="2">
					<textarea rows="10" id="content" class="form-control form-control-sm" name="content" style="resize: none;"></textarea>
				</td>
			</tr>
			<tr class="table-light">
				<td colspan="3" align="center">
					<input class="btn btn-primary btn-sm" type="submit" value="저장하기">
					<input class="btn btn-danger btn-sm" type="reset" value="다시쓰기">
