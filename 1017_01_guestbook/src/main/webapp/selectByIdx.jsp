...
//	보내고 삭제 버튼이 클릭된 경우 삭제할 글을 브라우저에 보여주는 페이지(delete.jsp)로 넘겨준다.
	...
	if (vo == null){
		...
		// 페이지(update.jsp)로 삭제 버튼이 클릭된 경우 삭제할 글을 브라우저에 보여주는 페이지(delete.jsp)로
		// request 영역에 얻어온 글, 페이지 번호, 줄바꿈에 사용할 \r\n을 저장해서 넘겨준다.
