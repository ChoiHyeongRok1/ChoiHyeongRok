...
<body>
	...
	<%
//  이클립스는 프로젝트를 실행하면 프로젝트를 이클립스가 내부적으로 사용하는 웹서버에 복사하고 실행된다.
//  D:\Web\work\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps => real path
//  application.getRealPath("/") 메소드를 실행하면 프로젝트가 실행되는 실제(real) 경로(path)를 얻어온다.

//  out.println(application.getRealPath("/") + "poll.txt"); // "/"는 web root(홈페이지 최초 진입 경로)를 의미한다.
	...
	//  투표 항목의 개수만큼 반복하며 radio와 투표 항목을 출력한다.  
	    ...
	    <tr>
	        <td align="center">
	            ...
	            <input type="button" value="결과보기" onclick="alert('!!!!!!!!')"> 
	        </td>
	    </tr>
	</table>
</form>
