...
public class StringTokenizerTest {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * // split()메소드는 구분자를 2개 이상 지정할 수 없으므로 공백과 탭이 섞여있는 // 데이터에 구분자를 공백만 지정하면 탭으로
		 * 구분된 데이터는 분리할 수 없다. str= "사과 배 복숭아	밤 대추"; String[]data = str.split(" ");
...
//		문자열 ","과 "="로 구분된 경우
		String str4 = "사과=1000,배=2000,복숭아=3300,밤=4400,대추=5500";
