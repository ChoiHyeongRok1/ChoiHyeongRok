...
//		서버에 접속한다.
//		192.168.0.75
			System.out.println("192.168.0.75 서버의 10006번 포트로 접속시도");
//		new Socket(host, port): host => 서버의 ip 주소, port => 서버의 포트 번호
			socket = new Socket("192.168.0.75", 10006);
...
//			클라이언트와의 통신이 종료되면 통신에 사용한 Socket 객체를 닫는다.
