//	aimate() 메소드로 여러 css 스타일을 이용해서 사용자 이펙트를 정의할 수 있다.
...
//		=> swing: 시작 부분과 끝 부분에서는 천천히 움직이고 중간 부분은 빠르게 움직인다.
	...
	$('p').bind('click', function () {
		...
		*/
		...
		switch (command){
			...
			// fadeTo(재생시간, 투명도): fade효과에서 사용하는 opacity 속성값을 직접 지정한다.
			// fadeTo() 메소드가 실행되며 투명도가 변경되면 변경된 투명도가 유지되며 표시되기 때문에
