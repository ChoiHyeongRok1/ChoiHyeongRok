...
//	console.log(inputs.length);
//	let inputs = $('input:text'); // input 태그 중에서 type 속성이 text인 태그 전체를 얻어온다.
//	console.log(inputs.length);
	
//	아래와 같이 사용하면 input 태그의 type 속성이 text인 요소가 여러개 있다 하더라도 첫 번째 요소의 값만 얻어온다.
//	let doc = $('input:text').val();
//	console.log(doc);
	
//	console.log(inputs);
//	배열의 인덱스 지정이 안된 상태에서 value를 사용하면 undefined
...
//	input.value = document.getElementsByTagName('input')[4].value;
//	console.log(input.value);
