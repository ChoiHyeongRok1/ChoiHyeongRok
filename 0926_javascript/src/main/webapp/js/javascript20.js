...
//	id가 아닌 name 속성이나 tag 이름으로 얻어오려면 id는 무조건 1개만 나올 수 있으므로 Element 처럼
//	단수형을 사용하고 name 속성이나 tag는 같은게 여러개 나올 수 있으므로 Elements 처럼 복수형을 사용한다.
//	getElementById() 함수는 1개만 얻어오기 때문에 그냥 사용하면 되지만 getElementsByName(), getElementsByTagName()
