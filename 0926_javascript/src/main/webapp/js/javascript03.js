...
console.log("'5' / 4 = " + Math.ceil('5' / 4)); // ceil() => 올림 함수

console.log("'5' / 3 = " + Math.floor('5' / 3)); // floor() => 내림 함수
...
//	자바스크립트는 '===', '!==' 연산자가 있다.
//	'==', '!=' 데이터 타입을 구분하지 않고 값만 비교한다.
//	'===', '!==' 데이터 타입과 값을 비교한다.
console.log(`10 === '10' => x: ${10 === '10'}`);
console.log(`10 !== '10' => x: ${10 !== '10'}`);
