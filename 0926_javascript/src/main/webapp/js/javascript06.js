...
//	객체의 멤버로 함수를 가질 수 있다.
	...
	say: function say(){
		// 함수에서 객체의 멤버를 참조할 때는 자신의 객체를 의미하는 this를 붙여야한다.
...
//	외부 함수를 cat 객체의 say() 함수로 주입한다.
cat.say = say;
console.log(cat);
cat.say();

//	dog객체의 say()함수를 cat객체의 say2()함수로 주입한다.
cat.say2 = dog.say;
console.log(cat);
cat.say2();
...
//	numbers.sum(); numbers.sum is not a function에러가 발생한다.
...
sum();
function sum(){
	console.log('객체 외부에서 만들어진 sum() 함수')
}
*/
