...
//	function을 사용해서 선언한 객체는 new를 사용해서 생성한다.
	const obj = new Clazz('홍길동');
	console.log(obj);
//	객체의 멤버에 접근하려면 객체 이름에 '.'을 찍어 접근한다.
	console.log(obj.name);
	console.log(obj.age); // 접근 불가능
	console.log(obj.getAge()); // 함수를 통해서 접근한다.
}
...
//	JSON.stringify() 인수로 지정된 json객체를 json을 가장한 문자열로 변환한다.
