...
function showMessage2(message, from = '수신미상'){
	console.log(`ES5: ${message} by ${from}`)
}

showMessage2('hi');
showMessage2('hi', 'hello');
console.log('=========================================');
...
//	향상된 for
//	향상된 for는 배열의 첫 번째 인덱스의 값을 변수에 넣고 반복을 시작하고 마지막 값을 변수에 넣고
//	반복한 후 종료된다.
	for (let arg of args){
		console.log(arg);
	}
...
//	변수에는 꼭 익명함수만 할당할 수 있는것이 아니고 일반 함수도 할당할 수 있다.
function sum(a, b) {
	return a+b
}
...
quit('정답', printYes, printNo);
quit('오답', printYes, printNo);
console.log('=========================================');
...
//	화살표함수의 인수가 1개일 경우 ()를 생략할 수 있다.
const whoAreYou4 = name => console.log(name + '님 안녕하세요');
whoAreYou3('일지매');
console.log('=========================================');

//	함수가 실행할 문장이 return 1문장만 있을 경우 {}를 생략하면 반드시 return도 생략해야 한다.
